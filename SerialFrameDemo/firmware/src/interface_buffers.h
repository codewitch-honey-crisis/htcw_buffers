...
#define INTERFACE_MAX_SIZE (67)
#define INTERFACE_ST_ESP_IDF_VERSION_MESSAGE_SIZE (0)
#define INTERFACE_ST_RNG_MESSAGE_SIZE (0)
#define INTERFACE_ST_GPIO_GET_MESSAGE_SIZE (8)
#define INTERFACE_ST_GPIO_SET_MESSAGE_SIZE (16)
#define INTERFACE_ST_GPIO_MODE_MESSAGE_SIZE (2)
#define INTERFACE_ST_MAC_ADDRESS_MESSAGE_SIZE (0)
#define INTERFACE_ST_ESP_IDF_VERSION_RESPONSE_MESSAGE_SIZE (67)
#define INTERFACE_ST_RNG_RESPONSE_MESSAGE_SIZE (4)
#define INTERFACE_ST_GPIO_GET_RESPONSE_MESSAGE_SIZE (8)
#define INTERFACE_ST_MAC_ADDRESS_RESPONSE_MESSAGE_SIZE (6)
