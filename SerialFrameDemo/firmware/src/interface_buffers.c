...
int st_gpio_get_message_read(st_gpio_get_message_t* s, buffers_read_callback_t on_read, void* on_read_state) {
    int res;
    int bytes_read = 0;
    res = buffers_read_uint64_t_be(&s->mask, on_read, on_read_state, &bytes_read);
    if(res < 0) { return res; }
    return bytes_read;
}
...
int st_gpio_get_message_write(const st_gpio_get_message_t* s, buffers_write_callback_t on_write, void* on_write_state) {
    int res;
    int total = 0;
    res = buffers_write_uint64_t_be(s->mask, on_write, on_write_state);
    if(res < 0) { return res; }
    total += res;
    return total;
}
...
int st_gpio_set_message_read(st_gpio_set_message_t* s, buffers_read_callback_t on_read, void* on_read_state) {
    ...
    res = buffers_read_uint64_t_be(&s->mask, on_read, on_read_state, &bytes_read);
    if(res < 0) { return res; }
    res = buffers_read_uint64_t_be(&s->values, on_read, on_read_state, &bytes_read);
    if(res < 0) { return res; }
    return bytes_read;
}
...
int st_gpio_set_message_write(const st_gpio_set_message_t* s, buffers_write_callback_t on_write, void* on_write_state) {
    ...
    if(res < 0) { return res; }
    total += res;
    res = buffers_write_uint64_t_be(s->values, on_write, on_write_state);
    if(res < 0) { return res; }
    total += res;
    return total;
}
...
int st_rng_response_message_read(st_rng_response_message_t* s, buffers_read_callback_t on_read, void* on_read_state) {
    int res;
    int bytes_read = 0;
    res = buffers_read_uint32_t_be(&s->value, on_read, on_read_state, &bytes_read);
    if(res < 0) { return res; }
    return bytes_read;
}
...
int st_rng_response_message_write(const st_rng_response_message_t* s, buffers_write_callback_t on_write, void* on_write_state) {
    int res;
    int total = 0;
    res = buffers_write_uint32_t_be(s->value, on_write, on_write_state);
    if(res < 0) { return res; }
    total += res;
    return total;
}
